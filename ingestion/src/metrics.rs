...
use prometheus::{
    ...
    register_int_gauge, CounterVec, Encoder, HistogramVec, IntCounter, IntCounterVec, IntGauge,
    TextEncoder,
};
...
lazy_static! {
    ...
    pub static ref WAL_SEGMENTS_PENDING: IntGauge = register_int_gauge!(
        "wal_segments_pending",
        "Number of WAL segments with un-acked entries",
    )
